function sendAjaxSeatPopup(start_date, train_type, ho, start_station, arrive_station, _this) {
	...
	$.ajax({
		...
		success: function(data){
			...
			$(".select_seat_box > ul > li").removeClass("other_seat");
		    ...
		    if(_this.parents('.timetable_list').find('.train_type>span:nth-child(1)').text()=="KTX"){
		      $(".seat_popup.KTX").css("display","block");
		    }else if(_this.parents('.timetable_list').find('.train_type>span:nth-child(1)').text()=="무궁화"){
		      $(".seat_popup.Mugunghwa").css("display","block");
		    }
		},
		error: function(request, status, error) { // Ex13.jsp 참고
...
$(function(){
  ...
  $(".btn_wrapper>button:nth-child(2)").click(function(){
	...
	sendAjaxSeatPopup(start_date, train_type, ho, start_station, arrive_station, _this);   // ex. 2023-01-19, 1312, 1
	// --------------------------- Ajax 끝.
  });
  ...
  $(".trainho").click(function(){
	...
	start_station = $(".station_div.start").text();
	arrive_station = $(".station_div.arrive").text();
	sendAjaxSeatPopup(start_date, train_type, ho, start_station, arrive_station, null);   // ex. 2023-01-19, 1312, 1
	// --------------------------- Ajax 끝.
